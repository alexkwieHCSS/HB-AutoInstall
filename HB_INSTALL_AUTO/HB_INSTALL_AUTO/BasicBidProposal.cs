...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left DoubleClick item 'HeavyBidApp.HBMultiDocumentInterface.Reports.SummaryReports.ConciseBidProposal' at Center.", repo.HeavyBidApp.HBMultiDocumentInterface.Reports.SummaryReports.ConciseBidProposalInfo, new RecordItemIndex(2));
            repo.HeavyBidApp.HBMultiDocumentInterface.Reports.SummaryReports.ConciseBidProposal.DoubleClick();
            Delay.Milliseconds(200);
