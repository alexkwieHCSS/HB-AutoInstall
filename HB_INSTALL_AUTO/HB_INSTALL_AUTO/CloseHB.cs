...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'HeavyBidApplication'.", repo.HeavyBidApplication.SelfInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.HeavyBidApplication.Self, new Duration(0));
